...
from utils import (DataAugmentation, Head, Loss, MultiCropWrapper,
                   clip_gradients)
...
def main():
    ...
    dataset_train_aug = deepcopy(dataset_train_plain)

    dataset_train_aug.dataset.transform = transform_aug
    ...
    for e in range(args.n_epochs):
        for images, _ in tqdm.tqdm(
            data_loader_train_aug, total=len(data_loader_train_aug)
        ):
